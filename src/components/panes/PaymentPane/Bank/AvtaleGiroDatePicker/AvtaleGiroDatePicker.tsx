...
const tooltipText =
  "Vi må av tekniske grunner melde inn trekk minst 6 dager i forveien, så første trekkdato må utsettes med én måned. Du kan velge en annen trekkdato om du ønsker å trekkes tidligere.";
